...
login_post_data = {'_token': page_token, 'email': '79052441@qq.com',
                   'password': yuri_password, 'remember': 'on'}

token_log_req = s.post('https://www.91flac.com/login',
                       data=login_post_data, headers=fake_headers)
...
print(s.get('https://www.91flac.com/users/favorites/singers').cookies['XSRF-TOKEN'])
# 至此，成功登录。
